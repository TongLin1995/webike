...
d["-20"]["Xs"] = [10*i for i in [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720,
...
d["-10"]["Xs"] = [10*i for i in [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720,
         760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360,
         1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1880, 1880,1880]]

d["0"]["Xs"] = [10*i for i in [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720,
         760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360,
         1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920,1920,1920]]

d["23"]["Xs"] = [10*i for i in [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720,
         760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360,
         1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960,1960]]

d["45"]["Xs"] = [10*i for i in [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720,
         760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360,
...
d["-20"]["Ys"] = [10*offset*i for i in [2.6,2.55,2.6,2.8,3.1,3.15,3.14375, 3.1374999999999997, 3.13125, 3.125, 3.11875,
...
d["-10"]["Ys"]  = [10*offset*i for i in [3.2,3.1,3.15,3.2,3.25,3.3,3.29125, 3.2824999999999998, 3.2737499999999997,
...
d["0"]["Ys"]  = [10*offset*(i+.2)for i in [3.6,3.56,3.52,3.48,3.44,3.40,3.39125, 3.3825, 3.37375, 3.3649999999999998,
...
d["23"]["Ys"]  = [10*offset*(i+.2) for i in [3.95,3.9,3.85,3.8,3.75,3.7,3.6862500000000002, 3.6725000000000003, 3.65875, 3.645,
...
d["45"]["Ys"] = [10*offset*(i+.2) for i in [4, 3.96, 3.92, 3.88, 3.84, 3.8, 3.7849999999999997, 3.77, 3.755, 3.7399999999999998,
   ...
   if temp == 0 or temp == 23 or temp == 45:
       ...
       for j in range(0, len(Vs)):
         ...
         if i > Ys[5]:
            ...
            if cutoff == "":
                cutoff = j #we want cutoff to be the first voltage of mode 3. That is where well start linearly interpolating to 0
                interpPerIncrement = model_func2_3Line(Ys[46], m1,b1,m2,b2,m3,b3, 2)/cutoff
